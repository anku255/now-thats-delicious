  ...
  if (!stores.length && skip) {
    req.flash(
      ...
      `Hey! You asked for page ${
        page
      }. But that doesn't exist. So, I have put you on page ${pages}`
    );
    res.redirect(`/stores/page/${pages}`);
    return;
  }
  res.render(`stores`, { title: 'Stores', stores, page, pages, count }); // key is same as value so we just pass 'stores'
};
